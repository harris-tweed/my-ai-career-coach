...
A personal career coach powered by Claude. It learns who you are, remembers your sessions, and gets more useful over time. Everything stays on your computer — nothing is shared externally.
...
Type anything to begin — the coach will take it from there.

---

## What happens next

On your first session, the coach will introduce itself, explain how it works, and guide you through a short intake process. After that, every session picks up from where the last one ended.
